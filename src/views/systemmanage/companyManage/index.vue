<template>
  <div class="layout_main">
    <div style="padding-bottom:10px;">
      ...
      <el-button @click="handleAddcustom" icon="el-icon-plus" type="primary">新增企业</el-button>
      <el-button
    ...
    >
      <template slot="comType" slot-scope="scope">
        <span v-if="scope.row.comType == 1">单位企业</span>
        <span style="color: #1383e6" v-else-if="scope.row.comType == 2">个人企业</span>
        <span v-else>其他</span>
      </template>
